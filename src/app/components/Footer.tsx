...
export default function Footer({ profile }: FooterProps) {
  ...
  // Use defaults if no profile data is available
  const name = localProfile?.name || 'Portfolio';
  const title = localProfile?.title || 'Data Analyst';
  const email = localProfile?.email || 'example@example.com';
  const linkedin = localProfile?.linkedin || 'https://linkedin.com';
  const github = localProfile?.github || 'https://github.com';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-3">
            ...
            <div>
              <h3 className="text-sm font-semibold uppercase text-gray-500 tracking-wider">Resources</h3>
              <ul className="mt-4 space-y-2">
